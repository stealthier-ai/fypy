...
# step2 : 替换conf内容
# step2 : 修改index.rst结构
# step3 : sphinx-apidoc -o source ../../fypy/
# step4 : make html
# step5 : make clean
...
# with open(os.path.join("../..", "fypy", "__init__.py"), "rt") as fp:
...
man_pages = [
    ("index", "fypy", "fypy Documentation", ["Lee"], 1)
]
